...
public class WormConfigSO : ScriptableObject
{
    ...
    [Min(0f)] public float patrolTurnWaitTime = 0.5f; // Wait time at patrol points if needed
    ...
    [Min(0f)] public float bounceGravityScale = 1.0f; // Default gravity reference
    ...
    public LayerMask playerLayer; // To detect player for hit/bounce
}
